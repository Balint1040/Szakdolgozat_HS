            ...
            <div className="container">
                <div className="row">
                    <div className="col-12 col-lg-7">
                        ...
                        <div className="d-flex flex-wrap pt-4 mt-5" data-aos="zoom-in-up" data-aos-offset="100">
                    ...
                    <div className="col-12 col-lg-5 ctaImgColumn" data-aos="zoom-in-up" data-aos-offset="300">
